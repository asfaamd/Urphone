            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto">
                        <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded" href="find_gadget.php" style="color:Orange">Find Gadget</a></li>
            ...
            <div class="row g-0">
                ...
                <div class="col-md-8">
                    <div class="card-body">
                        ...
                        <p><a href="catalog.php?id=<?= $gadget['Product_ID']; ?>" class="btn btn- btn-info text-light">Read More</a>
                    </div>
                </div>
            </div>
        </div>
